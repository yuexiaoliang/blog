...
description: "共享服务器中了勒索病毒之后，把共享前端目录初始化为 Git 仓库，用提交脚本加 Windows 任务计划程序实现无人值守的自动备份。"
---
...
![打开任务计划程序](/images/windows-git-auto-backup/./1.png)

### 创建任务

![创建任务](/images/windows-git-auto-backup/./2.png)

### 设置任务名称

![设置任务名称](/images/windows-git-auto-backup/./3.png)

### 新建触发器

![新建触发器](/images/windows-git-auto-backup/./4.png)
...
![新建操作](/images/windows-git-auto-backup/./5.png)

### 大功告成

确定以后运行任务试试吧，不要忘了在仓库中修改点东西哦～

![运行任务](/images/windows-git-auto-backup/./6.png)

![运行效果](/images/windows-git-auto-backup/./run.gif)